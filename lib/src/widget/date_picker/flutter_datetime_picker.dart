...
import 'package:pharmacy/src/widget/date_picker/data/date_model.dart';
import 'package:pharmacy/src/widget/date_picker/data/i18n_model.dart';
import 'package:pharmacy/src/widget/date_picker/data/datetime_picker_theme.dart'
    as data;
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? data.DatePickerTheme(),
  ...
  final data.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    data.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(data.DatePickerTheme theme) {
  ...
  Widget _renderItemView(data.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
      child: Row(
  ...
  // Title View
  Widget _renderTitleActionsView(data.DatePickerTheme theme) {
